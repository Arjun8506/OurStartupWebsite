  ...
  return (
    <div className="w-full min-h-screen">
      <div className="w-full min-h-screen py-4  mt-28">
        <h1 className="text-2xl sm:text-3xl text-center uppercase font-extrabold px-4">
          Our Services
        </h1>
        ...
        <div className="clip-polygon-2 w-full min-h-fit bg-[rgb(18,130,162)] py-4 px-4 text-white sm:px-8 sm:py-8">
          <Swiper
            spaceBetween={50}
            slidesPerView={1}
            className="w-full"
          ...
          >
            <SwiperSlide>
              <div className="flex flex-col gap-5 border-2 rounded-lg border-purple-300 mt-6">
                <div className="w-full min-h-[65vh] px-3 py-2 rounded-lg overflow-hidden flex flex-col gap-4 items-center sm:px-5 sm:py-4">
