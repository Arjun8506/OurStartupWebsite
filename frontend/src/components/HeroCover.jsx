...
const HeroCover = () => {
  ...
  return (
    <div className="w-full min-h-[80vh] sm:h-[150vh]  bg-[rgb(0,31,84)] relative">
      <div className=" flex flex-wrap gap-2 rotate-12 items-center ml-[-50vw] mt-[-20vh] sm:ml-[-15vw]  md:ml-[-40vw]">
        {rotatedDivsStrip}
      </div>
